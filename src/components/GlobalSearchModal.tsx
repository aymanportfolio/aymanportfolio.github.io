...
import { Search, X, Layers, Cpu, BookOpen, ArrowRight, GraduationCap } from 'lucide-react';
...
export const GlobalSearchModal: React.FC<GlobalSearchModalProps> = ({
  ...
  const allResults: SearchResult[] = [
    ...
    ...STUDY_MATERIALS.map((s) => ({
      type: 'page' as const,
      id: `study-${s.id}`,
      title: `[Study Material] ${s.title}`,
      description: `${s.category} • ${s.author} • ${s.description}`,
      route: 'study-materials' as PageRoute,
      category: s.category,
    })),
    {
      type: 'page' as const,
