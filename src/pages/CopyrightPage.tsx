    ...
    <div className="max-w-3xl mx-auto py-8 pb-16 space-y-8 font-sans">
      ...
      <div className="p-8 rounded-3xl bg-slate-900/80 border border-slate-800 space-y-6 text-sm text-slate-300 leading-relaxed">
        <section className="space-y-2">
          ...
          <p>
            All content, 3D interactive visualizations, research blog articles, hardware schematics, firmware source codes, and visual layout on <strong>aymanportfolio.github.io</strong> are protected by copyright laws © 2025-2026 AYMAN ULLAH.
          </p>
        </section>
